var rudderanalytics = (function (exports) {
  ...
  var CONFIG_URL = "https://api.rudderlabs.com/sourceConfig/?p=web&v=1.1.7";
  ...
  */
  ...
  var MoEngage = /*#__PURE__*/function () {
    ...
    _createClass(MoEngage, [{
      ...
      key: "track",
      value: function track(rudderElement) {
        logger.debug("inside track"); // Check if the anonymous id is same as previous session if not a new session will start
      ...
      value: function reset() {
        logger.debug("inside reset"); // reset the anonymous id
      ...
      value: function identify(rudderElement) {
        ...
        var _rudderElement$messag2 = rudderElement.message,
            anonymousId = _rudderElement$messag2.anonymousId,
            userId = _rudderElement$messag2.userId;
        var traits = rudderElement.message.context.traits; // check if anonymous id is same or not
        ...
        if (traits) {
          each_1(function name(value, key) {
          ...
          }, traits); // remove the custom properties from triats

          each_1(function remove(value, key) {
            if (Object.prototype.hasOwnProperty.call(traits, key)) delete traits[key];
          }, traitsMap); // send the remaining properties
