var rudderanalytics = (function (exports) {
  ...
  var CONFIG_URL = "https://api.rudderlabs.com/sourceConfig/?p=web&v=1.1.5";
  ...
  var MoEngage = /*#__PURE__*/function () {
    ...
    _createClass(MoEngage, [{
      ...
      value: function track(rudderElement) {
        ...
        this.moeClient.track_event(rudderElement.message.event, rudderElement.message.properties);
      }
    }, {
      key: "reset",
