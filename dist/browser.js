  ...
  */
  ...
  var CookieLocal = /*#__PURE__*/function () {
    ...
    _createClass(CookieLocal, [{
      ...
      value: function options() {
        ...
        console.log(domain); // the default maxage and path
        ...
        if (!this.get("test_rudder")) {
          this._options.domain = this.get("custom_cookie_domain") != undefined ? this.get("custom_cookie_domain") : null;
        }
  ...
  var Storage = /*#__PURE__*/function () {
    ...
    _createClass(Storage, [{
      ...
      key: "setCookieDomain",
      value: function setCookieDomain(value) {
