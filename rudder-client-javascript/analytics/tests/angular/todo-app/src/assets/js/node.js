          ...
          value: function identify(rudderElement) {
            ...
            for (var k in traits) {
              if (!!Object.getOwnPropertyDescriptor(traits, k) && traits[k]) {
                var hubspotkey = k.startsWith("rl_")
            ...
            if (traitsValue["address"]) {
              ...
              for (var _k in address) {
                if (
                  !!Object.getOwnPropertyDescriptor(address, _k) &&
                  address[_k]
                ) {
                  var _hubspotkey = _k.startsWith("rl_")
                    ? _k.substring(3, _k.length)
                    : _k;

                  _hubspotkey =
                    _hubspotkey == "street" ? "address" : _hubspotkey;
            ...
            var userProperties =
              rudderElement.rl_message.rl_context.rl_user_properties;

            for (var _k2 in userProperties) {
              if (
                !!Object.getOwnPropertyDescriptor(userProperties, _k2) &&
                userProperties[_k2]
              ) {
                var _hubspotkey2 = _k2.startsWith("rl_")
                  ? _k2.substring(3, _k2.length)
                  : _k2;
        ...
        },
        {
          ...
          value: function track(rudderElement) {
            ...
            if (
              ...
              console.log(
                "revenue: " + rudderElement.rl_message.rl_properties.revenue
              );
              eventValue["value"] =
                rudderElement.rl_message.rl_properties.revenue;
            }
