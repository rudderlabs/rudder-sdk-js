...
import { BASE_URL, FLUSH_QUEUE_SIZE, FLUSH_INTERVAL_DEFAULT } from './constants'
...
class EventRepository {
     ...
     */
    processQueueElement(url, headers, message, callback, timeout, queueFn) {
        try {
     ...
     * @memberof EventRepository
     */
    enqueue(rudderElement, type, callback) {
        ...
        this.payloadQueue.addItem({
            ...
            headers,
            message,
            callback: serialize({ fn: callback }),
        })
    }
}
