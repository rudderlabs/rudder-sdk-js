...
(() => {
  ...
  (function (global, factory) {
    ...
    var CNameMapping$V =
      ...
      _defineProperty(_CNameMapping$V, NAME$W, NAME$W),
    ...
    var CNameMapping$J =
      ...
      _defineProperty(_CNameMapping$K, 'Facebook Pixel', NAME$K),
    ...
    var CNameMapping$v =
      ...
      _defineProperty(_CNameMapping$w, 'Launch_Darkly', NAME$w),
      _defineProperty(_CNameMapping$w, 'Launch Darkly', NAME$w),
      _defineProperty(_CNameMapping$w, 'launchDarkly', NAME$w),
      _CNameMapping$w);
    ...
    var CNameMapping$u =
      ...
      _defineProperty(_CNameMapping$v, 'Linkedin_insight_tag', NAME$v),
    ...
    var CNameMapping$n =
      ...
      _defineProperty(_CNameMapping$o, 'Pinterest_Tag', NAME$o),
      _defineProperty(_CNameMapping$o, 'PINTERESTTAG', NAME$o),
      _defineProperty(_CNameMapping$o, 'pinterest', NAME$o),
      _defineProperty(_CNameMapping$o, 'PinterestAds', NAME$o),
      _defineProperty(_CNameMapping$o, 'Pinterest_Ads', NAME$o),
      _defineProperty(_CNameMapping$o, 'Pinterest', NAME$o),
      _CNameMapping$o);
    ...
    var CNameMapping$m =
      ...
      _defineProperty(_CNameMapping$n, 'Post_affiliate_pro', NAME$n),
      _defineProperty(_CNameMapping$n, 'Post Affiliate Pro', NAME$n),
      _defineProperty(_CNameMapping$n, 'postaffiliatepro', NAME$n),
      _defineProperty(_CNameMapping$n, 'POSTAFFILIATEPRO', NAME$n),
      _CNameMapping$n);
    ...
    var CNameMapping$i =
      ...
      _defineProperty(_CNameMapping$j, 'QuantumMetric', NAME$j),
      _defineProperty(_CNameMapping$j, 'quantumMetric', NAME$j),
      _defineProperty(_CNameMapping$j, 'quantummetric', NAME$j),
    ...
    var CNameMapping$h =
      ...
      _defineProperty(_CNameMapping$i, 'RedditPixel', NAME$i),
      _defineProperty(_CNameMapping$i, 'REDDITPIXEL', NAME$i),
      _defineProperty(_CNameMapping$i, 'redditpixel', NAME$i),
    ...
    var CNameMapping$f =
      ...
      _defineProperty(_CNameMapping$g, 'SnapPixel', NAME$g),
      _defineProperty(_CNameMapping$g, 'SNAPPIXEL', NAME$g),
      _defineProperty(_CNameMapping$g, 'snappixel', NAME$g),
    ...
    var CNameMapping$c =
      ...
      _defineProperty(_CNameMapping$d, 'GoogleAnalytics360', NAME$d),
    ...
    var CNameMapping$a =
      ...
      _defineProperty(_CNameMapping$b, 'dcm floodlight', NAME$b),
      _defineProperty(_CNameMapping$b, 'Dcm Floodlight', NAME$b),
      _defineProperty(_CNameMapping$b, 'DCMFloodlight', NAME$b),
      _defineProperty(_CNameMapping$b, 'dcmfloodlight', NAME$b),
      _defineProperty(_CNameMapping$b, 'DcmFloodlight', NAME$b),
    ...
    var CNameMapping$5 =
      ...
      _defineProperty(_CNameMapping$5, 'SnapEngage', NAME$5),
      _defineProperty(_CNameMapping$5, 'Snap_Engage', NAME$5),
      _defineProperty(_CNameMapping$5, 'snapengage', NAME$5),
    ...
    var CNameMapping$4 =
      ...
      _defineProperty(_CNameMapping$4, 'LiveChat', NAME$4),
      _defineProperty(_CNameMapping$4, 'Live_Chat', NAME$4),
      _defineProperty(_CNameMapping$4, 'livechat', NAME$4),
    ...
    var CNameMapping$1 =
      ...
      _defineProperty(_CNameMapping$1, 'Roll_Bar', NAME$1),
      _defineProperty(_CNameMapping$1, 'rollbar', NAME$1),
      _defineProperty(_CNameMapping$1, 'Rollbar', NAME$1),
    ...
    var CNameMapping =
      ...
      _defineProperty(_CNameMapping, 'QuoraPixel', NAME),
      _defineProperty(_CNameMapping, 'Quorapixel', NAME),
      _defineProperty(_CNameMapping, 'QUORAPIXEL', NAME),
      _defineProperty(_CNameMapping, 'Quora_Pixel', NAME),
      _defineProperty(_CNameMapping, 'quora_pixel', NAME),
      _defineProperty(_CNameMapping, 'Quora', NAME),
      _CNameMapping);
    ...
    function decryptValue(value) {
      ...
      if (value.substring(0, defaults$1.prefix.length) === defaults$1.prefix) {
        return AES.decrypt(value.substring(defaults$1.prefix.length), defaults$1.key).toString(
          Utf8,
        );
      }
    ...
    function getJSONTrimmed(context, url, writeKey, callback) {
      ...
      xhr.setRequestHeader(
        'Authorization',
        'Basic '.concat(btoa(''.concat(writeKey, ':'))), // `Basic ${Buffer.from(`${writeKey}:`).toString("base64")}`
      );
      ...
      try {
        if (error instanceof Event) {
          ...
          errorMessage = 'error in script loading:: src::  '
            ...
            .concat(error.target.id); // SDK triggered ad-blocker script
          ...
          value: function initialize(writeKey, url, options) {
            ...
            if (options && options.useBeacon && navigator.sendBeacon) {
              if (
                ...
                _typeof(options.beaconQueueOptions) === 'object'
              ) {
      ...
      _createClass(CookieConsentFactory, null, [
        {
          ...
          value: function initialize(cookieConsentOptions) {
             ...
             */
            if (
              cookieConsentOptions !== null &&
              cookieConsentOptions !== void 0 &&
              (_cookieConsentOptions = cookieConsentOptions.oneTrust) !== null &&
              _cookieConsentOptions !== void 0 &&
              _cookieConsentOptions.enabled
            ) {
            ...
            try {
              ...
              this.sessionInfo.autoTrack = !(
                (options === null || options === void 0
                  ? void 0
                  : (_options$sessions = options.sessions) === null || _options$sessions === void 0
                  ? void 0
                  : _options$sessions.autoTrack) === false || this.sessionInfo.manualTrack
              );
              /**
                ...
                var interval = setInterval(function () {
                  if (self.integrationSDKLoaded(pluginName, modName)) {
                    ...
                    try {
                      ...
                      e.message = "[Analytics] 'integration.init()' failed :: "
                        .concat(pluginName, ' :: ')
                        .concat(e.message);
                      handleError(e);
          ...
          value: function processOptionsParam(rudderElement, options) {
            ...
            for (var key in options) {
              if (topLevelElements.includes(key)) {
                ...
                rudderElement.message.context = merge(
        ...
        },
        {
          ...
          value: function loadAfterPolyfill(writeKey, serverUrl, options) {
            ...
            if (
              ...
              _typeof(options.sendAdblockPageOptions) === 'object'
            ) {
