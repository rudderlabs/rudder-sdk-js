console.log('Hi from popup script');
...
//     chrome.tabs.sendMessage(tab.id, { action: 'page' }, (response) => {
//       console.log("Response from content script: ", response);
//       if (response) {
//         document.getElementById("action").innerText = response.actionPerformed;
//         document.getElementById("rudderElement").innerText = JSON.stringify(response.event);
//       }
//     });
//   });
// });
...
//     },
//     (err, data) => {
//       sendResponse({ actionPerformed: 'Page tracked', event: data});
//     }
//     );
//   }
