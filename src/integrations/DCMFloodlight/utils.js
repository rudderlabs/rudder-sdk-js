 ...
 * @returns
 */
const generateRandomNumber = () => Math.random() * 10000000000000;
...
const buildCustomParamsForCounterTag = (message, countingMethod) => {
  ...
  switch (countingMethod) {
    case 'standard':
      customParams.ord = get(message, 'properties.ord') || generateRandomNumber();
      break;
    case 'unique':
      customParams.ord = 1;
      customParams.num = get(message, 'properties.num') || generateRandomNumber();
      break;
    case 'per_session':
