...
const prepareInAppMessagesPayload = (config) => ({
  ...
  onOpenScreenReaderMessage: config.onOpenScreenReaderMessage || undefined,
  onOpenNodeToTakeFocus: config.onOpenNodeToTakeFocus || undefined,
  packageName: config.packageName || undefined,
  rightOffset: config.rightOffset || undefined,
  topOffset: config.topOffset || undefined,
  bottomOffset: config.bottomOffset || undefined,
  handleLinks: config.handleLinks || undefined,
  closeButton: {
    ...
    isRequiredToDismissMessage: config.isRequiredToDismissMessage || undefined,
