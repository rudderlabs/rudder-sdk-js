...
describe("FacebookPixel init tests", () => {
  ...
  test("Testing init call of Facebook Pixel with identified user and updated mapping true", () => {
    ...
    facebookPixel = new FacebookPixel({ pixelId: "12567839", advancedMapping: true, useUpdatedMapping: true }, mockAnalytics, destinationInfo);
    facebookPixel.init();
  ...
  test("Testing init call of Facebook Pixel with identified user and updated mapping false", () => {
    ...
    facebookPixel = new FacebookPixel({ pixelId: "12567839", advancedMapping: true, useUpdatedMapping: false }, mockAnalytics, destinationInfo);
    facebookPixel.init();
    expect(typeof window.fbq).toBe("function");
    expect(facebookPixel.userPayload).toStrictEqual({
        "email": "abc@rudderstack.com",
...
describe("Facebook Pixel Track event", () => {
  ...
  let facebookPixel;
  beforeEach(() => {
    facebookPixel = new FacebookPixel({ pixelId: "12567839", useUpdatedMapping: true }, mockAnalytics, destinationInfo);
    facebookPixel.init();
    window.fbq = jest.fn();
  });
