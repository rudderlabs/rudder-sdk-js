...
describe("extractCustomFields Tests", () => {
    test("A success case", () => {
        ...
        const exclusionFields =  ["firstName","lastName","phone","title","organization","city","region","country","zip","image","timezone"];
        const result = utils.extractCustomFields(testMessageObj,testPayload, testKeys, exclusionFields );
