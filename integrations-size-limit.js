...
console.log("Checking integrations size limit...");

import { configToIntNames } from "./utils/config_to_integration_names";
const filePaths = Object.values(configToIntNames).map((intgName) => `/dist/integrations/${intgName}.min.js`);

const limits = {
  size: "512000", // 500 kB
}

sizeLimit.default([bigLibPlugin.default, webpackPlugin.default, timePlugin.default], filePaths).then(result => {
