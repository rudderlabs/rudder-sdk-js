...
For examples and specific details look into [Chrome Extensions Usage](https://github.com/bardeenai/rudder-sdk-js/blob/production/tests/chrome-extension/USAGE.md)
