...
describe('buildPayLoad_function', () => {
  ...
  it('test_default_pii_properties', () => {
    ...
    expect(
      buildPayLoad(rudderElement, whitelistPiiPropertiesMock, blacklistPiiPropertiesMock),
  ...
  it('test_empty_blacklist_pii_whitelist_pii_properties', () => {
    ...
    expect(
      buildPayLoad(rudderElement, emptyblacklistPiiPropertiesMock, emptywhitelistPiiPropertiesMock),
    ).toEqual(expectedPayload);
  });
  ...
  it('test_pii_properties_in_blacklist_excluded_or_hashed', () => {
    ...
    expect(payload).toEqual({
      ...
      BlacklistPiiPropertyHashTrue:
        'cde0eb46fc74cc39cb142e54bff325ea12a317c3b4521e71a7efab7121e598d7',
    });
  });
  ...
  it('test_payload_includes_all_properties_when_whitelist_contains_non_pii_and_blacklist_only_non_pii', () => {
    ...
    const expectedPayload = {
      nonPiiWhiteListedProperty: 'non-pii-value',
      BlacklistPiiPropertyHashTrue:
        '1a06df824ed741b53c785079a6347f00eec5af82f9850775409ca69dff4068a6',
    };
    const payload = buildPayLoad(
      rudderElement,
      whitelistPiiPropertiesMock,
  ...
  it('if_integrationobj_contains_hash_false_for_non_pii_blacklist', () => {
    ...
    expect(payload).toEqual({
      BlacklistPiiPropertyHashTrue:
        '735dd9dca6186f03c27694a4e65d4cadc4330cea27b6e46bc53d36f7fc3ae9a9',
    });
  });
