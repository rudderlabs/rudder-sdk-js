...
export { CNameMapping, BrazeOperationString, DISPLAY_NAME_TO_DIR_NAME_MAP, DIR_NAME };

export { BRAZE_NAME as NAME, BRAZE_DISPLAY_NAME as DISPLAY_NAME } from '../../Destinations';
